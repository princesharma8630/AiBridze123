<section class="services-partners-section">
    
    <!-- Partners Container -->
    <div class="services-partners-container">
        ...
        <div class="partners-marquee-wrapper">
            <div class="partners-marquee">
                <div class="partners-track">
                    ...
                    <div class="partner-item">
                        <img src="<?php echo get_template_directory_uri(); ?>/assests/service-page-image/partners/met.png" alt="Metriks Partner">
                    </div>
                    <div class="partner-item">
                        <img src="<?php echo get_template_directory_uri(); ?>/assests/service-page-image/partners/i-5.png
                    ...
                    <div class="partner-item">
                        <img src="<?php echo get_template_directory_uri(); ?>/assests/service-page-image/partners/i-5.png" alt="Metriks Partner">
                    </div>

                    <!-- Add more duplicates if you have more logos -->
