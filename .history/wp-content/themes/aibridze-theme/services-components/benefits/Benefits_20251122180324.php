        ...
        <div class="benefits-cards">
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/benefits/revenue-icon.png" alt="Revenue Growth Icon">
                </div>
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/benefits/cost-icon.png" alt="Cost Structure Icon">
                </div>
                <h3 class="benefit-card-title">
                    Cost-Structure<br>
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/benefits/risk-icon.png" alt="Risk Reduction Icon">
                </div>
                <h3 class="benefit-card-title">
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/benefits/decision-icon.png" alt="Decision Quality Icon">
                </div>
                <h3 class="benefit-card-title">
