...
function aibridze_enqueue_assets() {
 ...
 wp_enqueue_style(    
    ...
    //verticalexpertise
    wp_enqueue_style(    
        'verticalexpertise-style',
        get_template_directory_uri() . '/services-components/verticalexpertise/Verticalexpertise.css',
        array(),
        '1.0.0'
    );
    //cta-services
    wp_enqueue_style(    
        'cta-services-style',
        get_template_directory_uri() . '/services-components/cta-services/CtaServices.css',
        array(),
        '1.0.0'
    );
    // testimonials-style
     wp_enqueue_style(    
        'testimonial-style',
        get_template_directory_uri() . '/services-components/testimonials/Testimonials.css',
        array(),
        '1.0.0'
    );
    ...
    wp_enqueue_script(
        'testimonial-script',
        get_template_directory_uri() . '/components/testimonials/testimonial.js',
        array(),
        '1.0.0',
        true
    );
    ...
    //=========verticalexpertise=============//
    wp_enqueue_script(
        'verticalexpertise-js',
        get_template_directory_uri() . '/services-components/verticalexpertise/Verticalexpertise.js',
        array(),
        '1.0.0',
        true
    );
