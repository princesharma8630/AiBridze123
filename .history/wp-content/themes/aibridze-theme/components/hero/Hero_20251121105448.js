...
jQuery(document).ready(function($) {
            ...
            anim: function(){
                ...
                for(var i = 0; i < this.n; i++) {
                    ...
                    && this.test) {
                        ...
                        // Calculate star size based on depth (same as line width before)
                        var starSize = (1 - this.star_color_ratio * this.star[i][2]) * 2;
                        
                        // Draw dot/circle using the original star color
    ...
    $('.hero-stars-canvas').starfield({
        starColor: "rgba(255, 255, 255, 1)", // Cyan color matching your theme
