...
function aibridze_enqueue_assets() {
    ...
    wp_enqueue_style(
        'aibridze-industries-Compliance',
        get_template_directory_uri() . '/assets/css/industries-compliance.css',
        array(),
        '1.0.0'
    );
    
    wp_enqueue_style(
        'aibridze-industries-Hipaa',
        get_template_directory_uri() . '/assets/css/IndustriesHipaa.css',
        array(),
        '1.0.0'
    );
    
    wp_enqueue_style(
        'aibridze-industries-process',
        get_template_directory_uri() . '/assets/css/IndustriesProcess.css',
        array(),
        '1.0.0'
    );
    ...
    wp_enqueue_style(
        'aibridze-industries-Integration',
        get_template_directory_uri() . '/assets/css/IndustriesIntegration.css',
        array(),
        '1.0.0'
    );
    wp_enqueue_style(
        'aibridze-industries-WhyChoose',
        get_template_directory_uri() . '/assets/css/IndustriesWhyChoose.css',
        array(),
        '1.0.0'
    );
    // industries security styles
    wp_enqueue_style(
        'aibridze-industries-security',
        get_template_directory_uri() . '/assets/css/IndustriesSecurity.css',
        array(),
        '1.0.0'
    );
    ...
    wp_enqueue_script(
        'aibridze-industries-process',
        get_template_directory_uri() . '/assets/js/IndustriesProcess.js',
        array(),
        '1.0.0',
        true
    );
