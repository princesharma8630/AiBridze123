        ...
        <div class="articles-grid">
            ...
            <div class="articles-list">
                ...
                <article class="article-card article-small">
                    <div class="article-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assests/images/articles/a1.png" alt="AI Article" />
                    </div>
                    <div class="article-content">
                        <div class="article-meta">
                            <span class="article-date">Aug 25, 2025</span>
                ...
                <article class="article-card article-small">
                    <div class="article-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assests/images/articles/a2.png" alt="AI Article" />
                    </div>
                    <div class="article-content">
                        <div class="article-meta">
                            <span class="article-date">Aug 25, 2025</span>
                ...
                <article class="article-card article-small">
                    <div class="article-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assests/images/articles/a3.png" alt="AI Article" />
                    </div>
                    <div class="article-content">
                        <div class="article-meta">
                            <span class="article-date">Aug 25, 2025</span>
