        ...
        <div class="benefits-cards">
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assests/service-page-image/benefits/b1.png" alt="Revenue Growth Icon">
                </div>
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assests/service-page-image/benefits/b2.png" alt="Cost Structure Icon">
                </div>
                <h3 class="benefit-card-title">
                    Cost-Structure<br>
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assests/service-page-image/benefits/b3.png" alt="Risk Reduction Icon">
                </div>
                <h3 class="benefit-card-title">
            ...
            <div class="benefit-card">
                <div class="benefit-icon">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assests/service-page-image/benefits/b4.png" alt="Decision Quality Icon">
                </div>
                <h3 class="benefit-card-title">
