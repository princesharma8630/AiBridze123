...
<section class="industry-hero-section">
    ...
    if ($background_video) : ?>
        <video class="hero-video-bg" autoplay muted loop playsinline>
            <source src="<?php echo esc_url($background_video['C:\Users\DELL\Local Sites\aibridze1\app\public\wp-content\themes\aibridze-theme\assets\service-page-image\hero\background-with-blue-rounded-plasma-reflection-3-2025-10-17-00-08-40-utc.mp4']); ?>" type="video/mp4">
        </video>
    <?php endif; ?>
